  ...
  >
    ...
    >
      <div slot="title" class="dialog-title">
        {{ $t('dialog.tableDialog.title') }}
      </div>
      <el-form :model="tableChecker" :inline="true">
        <el-form-item :label="$t('dialog.tableDialog.rows')">
          <el-input-number
            ref="rowInput"
            size="mini"
        ...
        <el-form-item :label="$t('dialog.tableDialog.columns')">
          <el-input-number
            size="mini"
