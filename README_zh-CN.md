...
专为代码库文档设计的阅读模式。使用 [ZRead](https://github.com/ZreadAI/zread_cli) 为代码库生成文档后，使用 Markdown++ 打开代码库目录，在左侧导航栏上会出现"Z"按钮，即可像 ZRead 的 browse 一样浏览相关技术文档。非常适合探索和阅读生成的代码库文档，零干扰沉浸式体验。
