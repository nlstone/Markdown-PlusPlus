...
所有平台的安装包均可从 [发布页面](https://github.com/nlstone/Markdown-PlusPlus/releases/latest) 下载。

### macOS

从 [发布页面](https://github.com/nlstone/Markdown-PlusPlus/releases/latest) 下载最新版 `markdownpp-%arch%-mac.dmg`。

### Windows

从 [发布页面](https://github.com/nlstone/Markdown-PlusPlus/releases/latest) 下载：
- 安装版：`markdownpp-setup.exe`
- 免安装版：`markdownpp-portable.exe`

安装时可勾选将 MarkDown++ 设为 `.md` 文件的默认打开程序（默认勾选）。

### Linux

从 [发布页面](https://github.com/nlstone/Markdown-PlusPlus/releases/latest) 下载 AppImage、deb 或 rpm 包。
